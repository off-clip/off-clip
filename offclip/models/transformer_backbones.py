...
def mrm_vit_b16(**kwargs):
    ...
    # model = load_weight(model, "./pretrain_model/VITB-16-M3AE_last.ckpt") ## train from M3AE
    model = load_weight(model, "/root/dgist-ai-cxr/checkpoint/paper/Carzero/VITB-16-M3AE_last.ckpt") ## train from M3AE
